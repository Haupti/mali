...
class TextParserResult {
  ...
  TextParserResult(this.instructions, this.labelInstrPointers);
}

class TextParser {
  static TextParserResult parse(String code) {
    List<String> linesAndContents = ParserUtils.cleanLines(code);
    Map<String, int> labelInstrPointers = {};
